package au.id.martinstrauss.noninstantcamera.noninstantcamera;
...
public class MainActivity extends FlutterActivity {
  ...
  private static final String SHARE_CHANNEL = "channel:au.id.martinstrauss.noninstantcamera.share/share";
  ...
  private void shareFile(String path) {
    ...
    Uri contentUri = ShareFileProvider.getUriForFile(this, BuildConfig.APPLICATION_ID, imageFile);
